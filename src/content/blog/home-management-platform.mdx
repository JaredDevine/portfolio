...
Jared's unique skillset of design chops + Front-end skills put Metronome in a place to rapidly prototype, make crucial decisions and then move quickly towards launch. He was able to both build features and product from scratch but also work with existing design patterns, products decisions, and in collaboration with others. He's a good addition to any team.
